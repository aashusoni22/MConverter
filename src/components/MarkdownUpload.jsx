...
const MarkdownUpload = ({ onMarkdownLoad, onStartWriting }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[70vh] gap-6 p-8 border-2 border-dashed rounded-lg border-gray-600">
      <div className="flex flex-col items-center gap-2">
        ...
        <h3 className="text-xl font-semibold">Choose how to start</h3>
      </div>
